...
export const ENTRY_CONTAINER_CLASSES = 'flex items-center gap-3 px-4 py-1 bg-slate-800 rounded-lg border';
...
export const INSERT_FILE_BUTTON_CLASSES = 'p-1.5 text-slate-400 hover:text-blue-400 hover:bg-slate-700 rounded transition-colors';
export const INSERT_FOLDER_BUTTON_CLASSES = 'p-1.5 text-slate-400 hover:text-amber-400 hover:bg-slate-700 rounded transition-colors';
