...
echo ""
echo "=== 3. Pull model: qwen3:4b ==="
echo "This downloads ~2.5 GB on first run. Subsequent runs are instant."
...
echo "  ollama run qwen3:4b      # interactive chat in terminal"
echo "  ollama stop qwen3:4b     # unload model from memory"
