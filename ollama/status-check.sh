...
# Query model info about a given running model (in this case 'qwen3-silent' which is the custom 
# version of qwen3:4b that we set up in `ollama/configure.sh`)
ollama show qwen3-silent --modelfile
